...
WebSocket.prototype.onSocketConnect = function () {
  ...
  if (!this._onSocketData) {
    this._onSocketData = function(data) {
...
WebSocket.prototype.clearHandlers = function () {
  this.parser.reset();
  this.parser.removeAllListeners();
  if (this._onSocketData) {
    this.socket.removeListener('data', this._onSocketData);
  }
  Transport.prototype.clearHandlers.call(this);
};
